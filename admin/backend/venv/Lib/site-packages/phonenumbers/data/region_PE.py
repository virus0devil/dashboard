...
PHONE_METADATA_PE = PhoneMetadata(id='PE', country_code=51, international_prefix='00|19(?:1[124]|77|90)00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:(?:19[02-68]|(?:4[34]|5[14])[0-8]|687)\\d|7(?:173|(?:3[0-8]|55)\\d)|8(?:10[05689]|6(?:0[06-9]|1[6-9]|29)|7(?:0[0569]|[56]0)))\\d{4}|(?:1[0-8]|4[12]|5[236]|6[1-7]|7[246]|8[2-4])\\d{6}', example_number='11234567', possible_length=(8,), possible_length_local_only=(6, 7)),
