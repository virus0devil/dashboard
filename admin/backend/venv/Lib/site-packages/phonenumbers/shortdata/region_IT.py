...
PHONE_METADATA_IT = PhoneMetadata(id='IT', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='1(?:1(?:[2358]|6\\d{3})|46|87)', example_number='112', possible_length=(3, 6)),
    ...
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0\\d{2,3}|1(?:[2-57-9]|6(?:000|111))|3[39]|4(?:82|9\\d{1,3})|5(?:00|1[58]|2[25]|3[03]|44|[59])|60|8[67]|9(?:[01]|2[2-9]|4\\d|696))|4(?:2323|5045)|14\\d|(?:1(?:2|92[01])|4(?:3(?:[01]|[45]\\d\\d)|[478](?:[0-4]|[5-9]\\d\\d)|55))\\d\\d', example_number='112', possible_length=(3, 4, 5, 6, 7)),
