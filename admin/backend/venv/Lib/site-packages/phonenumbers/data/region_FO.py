...
PHONE_METADATA_FO = PhoneMetadata(id='FO', country_code=298, international_prefix='00',
    ...
    voip=PhoneNumberDesc(national_number_pattern='6[0-36]\\d{4}', example_number='601234', possible_length=(6,)),
    national_prefix_for_parsing='(10(?:01|[12]0|88))',
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{2})(\\d{2})', format='\\1 \\2 \\3', leading_digits_pattern=['[2-9]'], domestic_carrier_code_formatting_rule='$CC \\1')])
